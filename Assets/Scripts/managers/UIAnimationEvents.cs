...
public class UIAnimationEvents : MonoBehaviour
{
	...
	private void Update()
	{
		if (show_bars && Timeline_camera.fieldOfView!=120f)
		{
			...
			Timeline_camera.fieldOfView = Mathf.Lerp(Timeline_camera.fieldOfView, 120f, Time.deltaTime * Camera_speed);
		}
		else if ( !show_bars && Timeline_camera.fieldOfView != 80f)
		{
			...
			Timeline_camera.fieldOfView = Mathf.Lerp(Timeline_camera.fieldOfView, 104f, Time.deltaTime * Camera_speed);
		}
	}
